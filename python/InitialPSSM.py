...
arg.add_argument('-O', '--OUTPUT_FOLDER', help='setting the output folder')
argp = arg.parse_args()
...
for seq in Bio.SeqIO.parse(argp.FASTA,'fasta'):
    PSSM_o = open('{}/{}.ipssm'.format(argp.OUTPUT_FOLDER, seq.id),'w')
