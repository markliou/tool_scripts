...
n_hidden = 512 # 128 hidden layer num of features
...
weights = {
    ...
    'out': tf.Variable(tf.random_normal([n_hidden*2, n_classes])) # for birnn
}
biases = {
...
def RNN(x, weights, biases):
    ...
    #outputs, states, states_bk = rnn.stack_bidirectional_rnn(stacked_lstm, stacked_lstm_bk, x, dtype=tf.float32) # deep dirnn
