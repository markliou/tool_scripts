...
weights = {
    ...
    'wc1': tf.Variable(tf.random_normal([7, 7, 1, nodeno] ) ),
    # 5x5 conv, 128 inputs, 512 outputs
    'wc2': tf.Variable(tf.random_normal([7, 7, nodeno, nodeno]  ) ),
    
    # 5x5 conv, 512 inputs, 512 outputs
    'wc3': tf.Variable(tf.random_normal([7, 7, nodeno, nodeno]  ) ),
    # 5x5 conv, 512 inputs, 128 outputs
    'wc4': tf.Variable(tf.random_normal([7, 7, nodeno, nodeno]  ) ),
    # 5x5 conv, 128 inputs, 64 outputs
    'wc5': tf.Variable(tf.random_normal([7, 7, nodeno, nodeno]   ) ),
    # 5x5 conv, 128 inputs, 64 outputs
    'wc6': tf.Variable(tf.random_normal([7, 7, nodeno, nodeno]   ) ),
...
model_container = tf.train.Saver()
